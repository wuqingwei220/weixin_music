...
__DEFINE__(1660355735071, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1660355735072,"./event-store":1660355735073}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660355735072, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1660355735073, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1660355735072,"./utils":1660355735074}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660355735074, function(require, module, exports) {
...
return __REQUIRE__(1660355735071);
})()
